...
Released under [CC BY-SA 4.0](../../LICENSE). When using or adapting this glossary, please credit the authors listed in \`manifest.json\` and share derivatives under the same license.
`;
