...
Kada preset é un vokabuláriu pikenu i fokadu na un domain spesífiku — saúdi, edukason, sirvisus sivikus, tekenolojia, relijian, etc. Uzuárius di Skrebe ta navega na katalogu li dentu di aplikasan, ta instala kes ki es ta meste, i ta resebe sujestan di termu i tchek di konsistensia apropriadu pa domain, kantu sta tradusi.
